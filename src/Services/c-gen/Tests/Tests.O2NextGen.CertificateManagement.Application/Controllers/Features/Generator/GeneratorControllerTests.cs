...
using O2NextGen.CertificateManagement.Application.Controllers.Features.Generator;
using Tests.O2NextGen.CertificateManagement.Application.Base;

namespace Tests.O2NextGen.CertificateManagement.Application.Controllers.Features.Generator;

[TestFixture]
public class GeneratorControllerTests :
    BaseControllerTests<GeneratorController>
{
    [Test]
    [TestCase("GeneratorController")]
    ...
    {
        Assert.IsTrue(
            Attribute.GetCustomAttributes(typeof(GeneratorController), typeof(ApiVersionAttribute)).Any(att =>
